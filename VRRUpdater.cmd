@echo off
REM ============================================================================
REM  VRR UPDATER — VR Realms Creator Kit manager
REM
...
powershell -NoProfile -STA -ExecutionPolicy Bypass -File "%~dp0Tools\VRRUpdater-App.ps1"
if %ERRORLEVEL% EQU 0 goto :done

echo.
echo [VRR Updater] The window could not open. Falling back to text mode...
echo.

:console
powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0Tools\VRRUpdater-Console.ps1"
echo.
